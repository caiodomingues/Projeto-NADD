...
namespace NADD.Controllers
{
    public class AreasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AreaId,NomeArea,DtCriacao")] Area area)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AreaId,NomeArea,DtCriacao")] Area area)
        {
            if (id != area.AreaId)
            {
                return NotFound();
