...
namespace NADD.Controllers
{
    public class DisciplinasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DisciplinaId,NomeDisciplina,CursoId")] Disciplina disciplina)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DisciplinaId,NomeDisciplina,CursoId")] Disciplina disciplina)
        {
